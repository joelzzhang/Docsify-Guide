...
当在低版本的内核中安装了v18及以上的nodejs后，执行`npm -v`会报以下错误
...
查看系统内安装的glibc版本然后再根据分析可得知 新版的node v18开始 都需要GLIBC_2.27支持，可是目前系统内却没有那么高的版本
...
- **更新glibc**
  ...
  在安装glibc的时候可能会出现以下错误，如果没有错误下边这一步可以忽略
